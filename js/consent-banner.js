...
const SaahaConsent = (() => {
  ...
  function show() {
    ...
    /* النص بيوصف اللي بيصير فعلاً: قياس الزيارات (Google Analytics) شغّال دايماً،
       والموافقة بتفعّل الكوكيز الإعلانية (Meta) لحالها. أول صياغة كانت توحي إن
       الموافقة بتتحكّم بالتتبّع كلّه — وهاد مو صحيح، فوعد ما منوفيه أسوأ من بانر
       صريح. تفاصيل الاتنين بصفحة الخصوصية. */
    el.innerHTML = `
      <p>منستخدم كوكيز لقياس الزيارات، وكوكيز إعلانية لمعرفة أداء حملاتنا
         على فيسبوك وإنستغرام. موافقتك بتفعّل الإعلانية لحالها — بتقدر ترفضها
         وتكمّل تصفّح عادي، ما رح يتغيّر شي بالموقع.
